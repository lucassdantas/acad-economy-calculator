...
const BeforeInitApp = ({isAppStarted, setIsAppStarted}:{isAppStarted:boolean, setIsAppStarted:(isAppStarted:boolean)=>void}) => {
  return(
    <div className='w-full h-fit text-center flex flex-col items-center gap-4 md:flex-row'>
      ...
      <div className='w-full text-left md:flex md:flex-col md:items-start md:justify-between md:h-screen md:w-[50%]'>
        <img src={'/imgs/discount-man.png'} alt='Homem com ícones de desconto' className='w-[200px] block md:hidden'/>
      ...
      <div className='flex flex-col items-center justify-center md:justify-start md:text-start md:w-[50%] gap-4'>
        <Title tag='h1'>Descubra quanto sua academia pode economizar</Title>
        <Title tag='h2' className='text-acad-gray-dark'>sendo um associado ACAD Brasil!</Title>

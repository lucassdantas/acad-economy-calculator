...
export const BlueForm = ({className=''}:{className?:string}) => {
  return (
    <svg width="78" height="284" viewBox="0 0 78 284" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
...
export const YellowForm = ({className=''}:{className?:string}) => {
  return (
    <svg width="63" height="286" viewBox="0 0 63 286" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
